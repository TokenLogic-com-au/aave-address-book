...
export const ethereumAddresses: NetworkAddresses<{
  ...
  ACI_VESTING: Hex;
  LLAMARISK_VESTING: Hex;
  TOKENLOGIC_VESTING: Hex;
  CHAOS_LABS_VESTING: Hex;
  CHAOS_LABS: Hex;
  LLAMARISK: Hex;
  ACI: Hex;
}> = {
  ...
  addresses: {
    ...
    ACI_VESTING: '0x9bdbB2997D3Aa0bECc56DFC960e0e17d7E9AbAE1',
    LLAMARISK_VESTING: '0x1aF449783d8EE434a54bA9B1db9186a15B141a2A',
    TOKENLOGIC_VESTING: '0x831e9e6D5150c912D0f896142243FF7bC7255D62',
    CHAOS_LABS_VESTING: '0x1bDecEAE83c6Ca0f4D78Ee46D40881FAb26b10b1',
